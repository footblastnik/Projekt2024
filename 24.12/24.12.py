...
import os
import segno
team = input("вас приветствует бот про Реал Мадрида,чтоб начать напишите(start),если хотите остановиться-напишите(стоп)")
while team != 'стоп':
    if team == "start":
        start = input("поиграем в игру(1),узнать иформацию о игроках(2),картинки(3),кюаркод тгк канала Реал мадрида(4)")
        if start == '1':
            score = 0
            for i in range(3):
                print(i)
        ...
        if start == '2':
            ...
            s = input("выберите игрока про которого хотите узнать информацию").capitalize()
